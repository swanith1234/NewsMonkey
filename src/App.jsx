    ...
    return (
      <Router>
        <div>
          ...
          <Route path="/politics" element={<Newscomponent key="politics" category="politics"/>} />
          <Route path="/education" element={<Newscomponent  key="education" category="science"/>} />
          ...
          <Route path="/travel" element={<Newscomponent key="travel" category="travel"/>} /></Routes>
        </div>
      </Router>
    );
  }
